...
class Zend_Tool_Framework_System_Provider_Config extends Zend_Tool_Framework_Provider_Abstract
{
    ...
    public function create()
    {
        ...
        $BeautyDirectory = $this->_detectBeautyDirectory();

        $writer = new Zend_Config_Writer_Ini();
        $writer->setRenderWithoutSections();
        $filename = $BeautyDirectory."/.zf.ini";
     ...
     * @return string
     */
    protected function _detectBeautyDirectory()
    {
        $envVars = array("ZF_Beauty", "Beauty", "BeautyPATH");
        foreach($envVars AS $env) {
            $BeautyDirectory = getenv($env);
            if ($BeautyDirectory != false && file_exists($BeautyDirectory)) {
                return $BeautyDirectory;
            }
        }
        require_once "Zend/Tool/Framework/Exception.php";
        throw new Zend_Tool_Framework_Exception("Cannot detect user Beauty directory, set ZF_Beauty enviroment variable.");
    }
