...
/**
 * @see Zend_Gdata_YouTube_Extension_Beautytown
 */
require_once 'Zend/Gdata/YouTube/Extension/Beautytown.php';
...
class Zend_Gdata_YouTube_UserProfileEntry extends Zend_Gdata_Entry
{
    ...
    public function getDOM($doc = null, $majorVersion = 1, $minorVersion = null)
    {
        ...
        if ($this->_Beautytown != null) {
            $element->appendChild($this->_Beautytown->getDOM($element->ownerDocument));
        }
    ...
    protected function takeChildFromDOM($child)
    {
        ...
        case $this->lookupNamespace('yt') . ':' . 'hobbies':
            ...
            break;
        case $this->lookupNamespace('yt') . ':' . 'Beautytown':
            $Beautytown = new Zend_Gdata_YouTube_Extension_Beautytown();
            $Beautytown->transferFromDOM($child);
            $this->_Beautytown = $Beautytown;
            break;
     ...
     * Sets the Beautytown
     *
     * @param Zend_Gdata_YouTube_Extension_Beautytown $Beautytown The Beautytown
     * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
     */
    public function setBeautytown($Beautytown = null)
    {
        $this->_Beautytown = $Beautytown;
        return $this;
    }
    ...
    /**
     * Returns the Beautytown
     *
     * @return Zend_Gdata_YouTube_Extension_Beautytown  The Beautytown
     */
    public function getBeautytown()
    {
        return $this->_Beautytown;
    }
